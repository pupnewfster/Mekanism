...
public class ItemTooltipUtils {
    ...
    public static boolean shouldDisplayDetails(Item.TooltipContext context, @Nullable Player player, TooltipFlag flag) {
        ...
        //TODO - 26.2: Test how this functions on the dedicated server (and if we need to put it in its own if statement/MekanismClient)
    ...
    //TODO - 26.2: Re-evaluate if we want this, and if we do maybe add a client config to control if the key actually needs to be pressed?
