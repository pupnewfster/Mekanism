...
public final class HeatContainerType extends AbstractContainerType<IHeatCapacitor, HeatCapacitorData> implements ISingleContainerType<IHeatCapacitor, HeatCapacitorData> {
    ...
    HeatContainerType() {
        super(MekanismDataComponents.ATTACHED_HEAT, SerializationConstants.HEAT_CAPACITORS, HeatCapacitorData.EMPTY);
    }
    ...
    @Override
    protected boolean shouldAddAttachment(HeatCapacitorData data) {
        return !data.isEmpty();
    }
